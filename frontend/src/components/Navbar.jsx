    ...
    <nav className="navbar">
      <div className="container navbar-container">
        ...
        <div className="nav-actions">
          <Link to="/contact" className="nav-connect-pill">
      ...
      <div className={`mobile-nav-drawer ${mobileMenuOpen ? 'open' : ''}`}>
        ...
        <Link to="/about" className="mobile-nav-link">About <span>→</span></Link>
        <Link to="/services" className="mobile-nav-link">Services <span>→</span></Link>
        <Link to="/pricing" className="mobile-nav-link">Pricing & Plans <span>→</span></Link>
        <Link to="/blog" className="mobile-nav-link">Blogs <span>→</span></Link>
        <Link to="/readiness-score" className="mobile-nav-link">Free Audit Tool <span>→</span></Link>
        ...
        <div style={{ paddingTop: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <Link to="/contact" className="nav-connect-pill" style={{ width: '100%', textAlign: 'center', justifyContent: 'center' }}>
            Let's Connect
          </Link>
          <a 
